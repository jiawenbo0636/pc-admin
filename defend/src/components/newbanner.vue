<template>
  <div class="newban">
    ...
    <dialog-bar v-model="send1" type="confirm" title="新建banner" content="您还有选项未填完!" :cancel="clickCancel()" ></dialog-bar>
    <dialog-bar v-model="send2" type="confirm" title="新建banner" content="提交成功!" :cancel="clickCancel()" @confirm="clickConfirm(name)"></dialog-bar>
    <dialog-bar v-model="send3" type="confirm" title="新建banner" content="提交失败!" :cancel="clickCancel()"></dialog-bar>
    <div class="content">
      <p><span>标题</span><input type="text" placeholder="请输入标题" class="text1"></p>
  ...
  export default {
    ...
    methods: {
      ...
      tirggerFile: function(event) {
        ...
        formdata.append('module', 'website/index/banner')
